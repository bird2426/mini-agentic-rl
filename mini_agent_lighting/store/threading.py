...
class LightningStoreThreaded(LightningStore):
    ...
    async def enqueue_rollout(
        ...
        with self._lock:
            return await self.store.enqueue_rollout(
                input, mode, resources_id, config, metadata
            )
    ...
    async def dequeue_many_rollouts(
        ...
        *,
        ...
        with self._lock:
            return await self.store.dequeue_many_rollouts(
    ...
    async def add_otel_span(
        ...
        with self._lock:
            return await self.store.add_otel_span(
                rollout_id, attempt_id, readable_span, sequence_id
            )
    ...
    async def wait_for_rollouts(
        ...
        return await self.store.wait_for_rollouts(
