...
from mini_agent_lighting.semconv import AGL_ANNOTATION, LightningSpanAttributes, RewardPydanticModel
from mini_agent_lighting.types import SpanCoreFields, SpanLike
...
def emit_reward(
    ...
    *,
    ...
    Examples:
        ...
        >>> from mini_agent_lighting.utils.otel import make_link_attributes
        >>> emit_reward(0.5, attributes=make_link_attributes({"gen_ai.response.id": "response-123"}))

        Or adding tags onto the reward span:
        >>> from mini_agent_lighting.utils.otel import make_tag_attributes
