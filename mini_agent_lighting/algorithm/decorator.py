...
from mini_agent_lighting.adapter import TraceAdapter
from mini_agent_lighting.store.base import LightningStore
from mini_agent_lighting.types import Dataset, NamedResources
...
AlgorithmFuncAsync = Union[
    AlgorithmFuncAsyncOnlyStore, AlgorithmFuncAsyncOnlyDataset, AlgorithmFuncAsyncFull
]

AlgorithmFuncSync = Union[
    AlgorithmFuncSyncOnlyStore, AlgorithmFuncSyncOnlyDataset, AlgorithmFuncSyncFull
]
...
class FunctionalAlgorithm(Algorithm, Generic[AF]):
    ...
    def __init__(
        ...
        algorithm_func: AlgorithmFuncSyncLike,
    ) -> None: ...

    @overload
    def __init__(
        self: "FunctionalAlgorithm[Literal[True]]",
        algorithm_func: AlgorithmFuncAsyncLike,
    ) -> None: ...

    def __init__(
        self, algorithm_func: Union[AlgorithmFuncSyncLike, AlgorithmFuncAsyncLike]
    ) -> None:
...
def algo(
    ...
    Examples:
        ```python
        from mini_agent_lighting.algorithm.decorator import algo
